...
# Create a data frame for rejected samples only
...
# Plot 1: Average Estimate of μ̂ vs. True Value of μ
...
# Plot 2: Average Estimate of μ̂ in Samples Where Null Was Rejected vs. True Value of μ
ggplot() +
